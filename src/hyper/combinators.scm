...
(define (column->string column)
  (list->string (car column)))

(define parse-column
  (parse-map column->string
             (parse-each (parse-one-or-more (parse-unless (parse-char #\;)
                                                          parse-any-char))
              (parse-char #\;))))
...
(define parse-row
  (parse-map car
             (parse-each (parse-one-or-more
                          (parse-unless (parse-any parse-end
                                                   (parse-char #\newline))
                                        parse-column))
                         (parse-any parse-end
                                    (parse-char #\newline)))))
...
(define parse-csv
  (parse-one-or-more parse-row))

(define-public (csv string)
